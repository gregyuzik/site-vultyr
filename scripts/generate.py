...
STRINGS = {
    "en": {
        ...
        "home_features": [
            ("chart-bar-regular.svg", "Live Status Dashboard",
             "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic and 300+ more, all in one place. Tap a tile to expand the incident inline."),
            ("bell-ringing-regular.svg", "Smart Alerts",
             "Down and recovery notifications with each service's favicon attached on iOS. Major outages pulse noticeably larger than minor incidents, so severity reads at a glance. Per-component watch, mute, hide, and quiet hours let you silence what you don't care about on the schedule you set."),
    ...
    "ru": {
        ...
        "home_features": [
            ("chart-bar-regular.svg", "Дашборд статуса в реальном времени",
             "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic и 300+ других, всё в одном месте. Индикаторы статуса синхронизируются с 120Гц ProMotion на iPhone Pro и iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Live-statusdashboard",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic og 300+ andre, alle ét sted. Statusindikatorerne synkroniseres med 120Hz ProMotion på iPhone Pro og iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Live-Status-Dashboard",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic und 300+ weitere, alles an einem Ort. Die Status-Orbs synchronisieren sich mit 120Hz ProMotion auf iPhone Pro und iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Panel de estado en vivo",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic y más de 300, todo en un solo lugar. Los indicadores de estado se sincronizan con ProMotion de 120Hz en iPhone Pro y iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Tableau de bord d’état en direct",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic et plus de 300 autres, tout au même endroit. Les orbes de statut se synchronisent avec ProMotion 120Hz sur iPhone Pro et iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Dashboard di stato in tempo reale",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic e oltre 300 altri, tutti in un unico posto. Gli indicatori di stato si sincronizzano con ProMotion a 120Hz su iPhone Pro e iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "リアルタイムステータスダッシュボード",
         "AWS、GitHub、Cloudflare、Slack、Stripe、Discord、OpenAI、Anthropicなど300以上のサービスを一ヶ所で。ステータスインジケーターはiPhone ProとiPad Proの120Hz ProMotionに同期します。"),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "실시간 상태 대시보드",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic 등 300개 이상의 서비스를 한곳에서 확인하세요. 상태 표시등은 iPhone Pro와 iPad Pro의 120Hz ProMotion에 동기화됩니다."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Sanntids statusdashbord",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic og 300+ andre, alle på ett sted. Statusindikatorene synkroniseres med 120Hz ProMotion på iPhone Pro og iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Live statusdashboard",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic en 300+ meer, allemaal op één plek. De status-orbs synchroniseren met 120Hz ProMotion op iPhone Pro en iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Painel de status em tempo real",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic e mais de 300, tudo em um só lugar. Os indicadores de status sincronizam com ProMotion de 120Hz no iPhone Pro e iPad Pro."),
        ("bell-ringing-regular.svg", "Alertas inteligentes",
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Live-statusinstrumentpanel",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic och 300+ till, allt på ett ställe. Statusindikatorerna synkroniseras med 120Hz ProMotion på iPhone Pro och iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Canlı durum kontrol paneli",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic ve 300+ daha fazlası, hepsi tek yerde. Durum göstergeleri iPhone Pro ve iPad Pro'daki 120Hz ProMotion ile senkronize olur."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "Bảng điều khiển trạng thái trực tiếp",
         "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic và 300+ dịch vụ khác, tất cả ở một nơi. Các chỉ báo trạng thái đồng bộ với ProMotion 120Hz trên iPhone Pro và iPad Pro."),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "实时状态仪表板",
         "AWS、GitHub、Cloudflare、Slack、Stripe、Discord、OpenAI、Anthropic 和 300+ 服务, 一个地方尽览。状态图标与 iPhone Pro 和 iPad Pro 的 120Hz ProMotion 同步。"),
    ...
    "home_features": [
        ("chart-bar-regular.svg", "即時狀態儀表板",
         "AWS、GitHub、Cloudflare、Slack、Stripe、Discord、OpenAI、Anthropic 和 300+ 服務, 一個地方盡覽。狀態圖示與 iPhone Pro 和 iPad Pro 的 120Hz ProMotion 同步。"),
