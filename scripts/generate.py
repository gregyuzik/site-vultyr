...
STRINGS = {
    "en": {
        ...
        "home_features": [
            ...
            ("cloud-check-regular.svg", "Mac Hub — iPhone Fallback",
             "Mac is the most reliable hub: it polls every 60 seconds and broadcasts status changes to iPhone, iPad, Watch, and Vision Pro via iCloud. If no Mac is online, your iPhone steps in as the fallback publisher so the other devices still get alerts."),
    ...
    "ru": {
        ...
        "home_features": [
            ...
            ("cloud-check-regular.svg", "Mac — центр, iPhone — резерв",
             "Mac — самый надёжный центр: он проверяет каждые 60 секунд и рассылает изменения статуса на iPhone, iPad, Watch и Vision Pro через iCloud. Если Mac не в сети, ваш iPhone замещает его в качестве резервного издателя, чтобы другие устройства всё равно получали уведомления."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac-hub — iPhone som reserve",
         "Mac er den mest pålidelige hub: den poller hvert 60. sekund og sender statusændringer til iPhone, iPad, Watch og Vision Pro via iCloud. Hvis ingen Mac er online, overtager din iPhone som reserveudgiver, så de andre enheder stadig får notifikationer."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac-Hub — iPhone als Fallback",
         "Der Mac ist der zuverlässigste Hub: Er fragt alle 60 Sekunden ab und sendet Statusänderungen per iCloud an iPhone, iPad, Watch und Vision Pro. Wenn kein Mac online ist, übernimmt dein iPhone als Fallback-Publisher, damit die anderen Geräte weiterhin Benachrichtigungen erhalten."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac como hub — iPhone de respaldo",
         "El Mac es el hub más fiable: consulta cada 60 segundos y difunde los cambios de estado al iPhone, iPad, Watch y Vision Pro mediante iCloud. Si ningún Mac está en línea, tu iPhone actúa como publicador de respaldo para que los demás dispositivos sigan recibiendo alertas."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac comme hub — iPhone en relais",
         "Le Mac est le hub le plus fiable : il interroge toutes les 60 secondes et diffuse les changements de statut vers iPhone, iPad, Watch et Vision Pro via iCloud. Si aucun Mac n’est en ligne, ton iPhone prend le relais en tant qu’émetteur de secours afin que les autres appareils continuent de recevoir les alertes."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac come hub — iPhone di riserva",
         "Mac è l’hub più affidabile: interroga ogni 60 secondi e trasmette i cambi di stato a iPhone, iPad, Watch e Vision Pro tramite iCloud. Se nessun Mac è online, il tuo iPhone subentra come publisher di riserva in modo che gli altri dispositivi ricevano comunque le notifiche."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Macがハブ — iPhoneがフォールバック",
         "Macは最も信頼性の高いハブです。60秒ごとにチェックし、状態変更をiCloud経由でiPhone、iPad、Watch、Vision Proにブロードキャストします。Macがオンラインになければ、iPhoneがフォールバックパブリッシャーとして代わりに、ほかのデバイスにアラートを届けます。"),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac 허브 — iPhone 폴백",
         "Mac은 가장 안정적인 허브입니다. 60초마다 상태를 폴링하고 iCloud를 통해 iPhone, iPad, Watch, Vision Pro에 상태 변경을 전파합니다. Mac이 오프라인이면 iPhone이 폴백 퍼블리셔로 나서서 다른 기기들이 여전히 알림을 받도록 합니다."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac-hub — iPhone som reserve",
         "Mac er den mest pålitelige huben: den sjekker hvert 60. sekund og sender statusendringer til iPhone, iPad, Watch og Vision Pro via iCloud. Hvis ingen Mac er online, tar iPhone over som reserveutgiver slik at de andre enhetene fortsatt får varsler."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac-hub — iPhone als reserve",
         "Mac is de betrouwbaarste hub: peilt elke 60 seconden en stuurt statuswijzigingen via iCloud door naar iPhone, iPad, Watch en Vision Pro. Als er geen Mac online is, neemt je iPhone het als reserve-publisher over zodat de andere apparaten toch meldingen krijgen."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Hub no Mac — iPhone como reserva",
         "O Mac é o hub mais confiável: consulta a cada 60 segundos e transmite mudanças de status ao iPhone, iPad, Watch e Vision Pro via iCloud. Se nenhum Mac estiver online, seu iPhone assume como publicador reserva para que os outros dispositivos continuem recebendo alertas."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac-hub — iPhone som reserv",
         "Mac är den pålitligaste huben: den pollar var 60:e sekund och skickar statusförändringar till iPhone, iPad, Watch och Vision Pro via iCloud. Om ingen Mac är online tar din iPhone över som reservavsändare så att de andra enheterna fortfarande får aviseringar."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac hub — iPhone yedek",
         "Mac en güvenilir hub'dır: her 60 saniyede bir sorgular ve durum değişikliklerini iCloud üzerinden iPhone, iPad, Watch ve Vision Pro'ya yayınlar. Çevrimiçi Mac yoksa iPhone'unuz yedek yayıncı olarak devreye girer, böylece diğer cihazlar yine de uyarı alır."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac làm trung tâm — iPhone dự phòng",
         "Mac là trung tâm đáng tin cậy nhất: kiểm tra mỗi 60 giây và phát thay đổi trạng thái tới iPhone, iPad, Watch và Vision Pro qua iCloud. Nếu không có Mac nào trực tuyến, iPhone của bạn sẽ thay thế làm nhà xuất bản dự phòng để các thiết bị khác vẫn nhận được cảnh báo."),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac 作为中心 — iPhone 作为备用",
         "Mac 是最可靠的中心：每 60 秒轮询一次，并通过 iCloud 将状态变化广播至 iPhone、iPad、Watch 和 Vision Pro。如果没有 Mac 在线，你的 iPhone 会接替成为备用发布者，让其他设备仍然能收到告警。"),
    ...
    "home_features": [
        ...
        ("cloud-check-regular.svg", "Mac 作為中心 — iPhone 作為備用",
         "Mac 是最可靠的中心：每 60 秒輪詢一次，並透過 iCloud 將狀態變化廣播至 iPhone、iPad、Watch 和 Vision Pro。如果沒有 Mac 在線，你的 iPhone 會接替成為備用發布者，讓其他設備仍然能收到警報。"),
