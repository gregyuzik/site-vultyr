    ...
    "en": {
        ...
        "home_features": [
            ("chart-bar-regular.svg", "Live Status Dashboard",
             "AWS, GitHub, Cloudflare, Slack, Stripe, Discord, OpenAI, Anthropic and 300+ more — all in one place. Status orbs sync to 120Hz ProMotion on iPhone Pro and iPad Pro."),
